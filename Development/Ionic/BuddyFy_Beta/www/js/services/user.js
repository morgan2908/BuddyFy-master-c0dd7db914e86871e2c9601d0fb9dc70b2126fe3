var app = angular.module('buddyfy.services.userService', ["firebase"]);
...
var usersRef = new Firebase(FIREBASE_URL + "/users");
	...
	var self = {
		...
		loadUser: function () {
			...
			var currentUserId = $localstorage.get('buddytest-user', null);
		...
		logoutUser: function () {
			$localstorage.set('buddytest-user', null);
			self.current = {};
		},
		/*
		 Login the user
											...
											.then(function (authData) {
												...
												usersRef.child(authData.uid)
													...
													function (error, committed) {
														...
														//
														$localstorage.set('buddytest-user', authData.uid);
