// var mod = angular.module('buddyfy.services', [
// 	'buddyfy.services.userService',
// ]);

var app = angular.module('buddyfy.services', [])

app.factory('venues', function() {
  ...
  return {
    ...
    get: function(venuesId) {
      for (var i = 0; i < venues.length; i++) {
        if (venues[i].id === parseInt(venuesId)) {
          return venues[i];
        }
      }
      return null;
...
app.service('Products', function() {
  ...
  return {
    ...
    getByCate: function(venuesId) {
      var product_cate = [];
      for (var i = 0; i < products.length; i++) {
        if (products[i].cateId === parseInt(venuesId)) {
